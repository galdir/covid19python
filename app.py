                    ...
                    figure={
                        'data': [
                            ...
                            dict(
                                ...
                                y=df[df['state'] == 'BA']['rateNewCases'].rolling(window=5).mean(),
                                name='Média Movel de 5 Dias',
                                type='line'
                            )
                        ],
                        'layout': dict(
                            xaxis={'type': 'line', 'title': 'data', 'range':[umMesAtras,today]},
                            yaxis={
                                'title': 'taxa (%)',
                    ...
                    figure={
                        'data': [
                            ...
                            dict(
                                ...
                                y=df[df['state'] == 'BA']['rateNewDeaths'].rolling(window=5).mean(),
                                name='Média Movel de 5 Dias',
                                type='line'
                            )
                        ],
                ...
                figure={
                    'data': [
                        dict(
                            ...
                            y=df[df['state'] == i]['rateNewCases'].rolling(window=5).mean(),
                ...
                figure={
                    'data': [
                        dict(
                            # x=df[df['continent'] == i]['gdp per capita'],
                            x=df[df['state'] == i]['date'],
                            y=df[df['state'] == i]['rateNewDeaths'].rolling(window=5).mean(),
                            # text=df[df['state'] == i]['state'],
                            # mode='markers',
                            # opacity=0.7,
                            # marker={
